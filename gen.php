...
foreach($aisles as $aislename => $sections){
        ...
        foreach($sections as $sectioncode => $v){
                echo "<tr style=\"border: solid thin;\"><td></td><td></td><td>$sectioncode $v[0]</td><td>Size</td><td>Base</td><td>Retail</td><td>New Retail</td><td>FS</td><td>New FS</td><td>Batch</td></tr>";
                foreach($v[1] as $ite){
                        echo"<tr>
                        <td>$ite->ordercode</td>
                        <td>$ite->upc</td>
